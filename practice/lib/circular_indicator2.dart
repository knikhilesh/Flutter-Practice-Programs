...
class CircularDeterminate extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      home: CircularProgressIndicatorDemo(),
    );
  }
}
...
class CircularProgressIndicatorAppState extends State<CircularProgressIndicatorDemo>{
 late bool _loading;
